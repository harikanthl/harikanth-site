...
date: 2023-06-15
description: ESP32-based home automation — 12 relay control, Firebase sync, and a React Native companion app.
tags:
  - IoT
  - Hardware
  - Embedded
...
tech:
  ...
  - Expo
  - BLE
image: /images/projects/smarthome.svg
---

A comprehensive smart home automation system built around an ESP32 — WiFi provisioning, Firebase Realtime Database sync, and a React Native mobile app for remote control.
...
I wanted a self-hosted alternative to commercial smart plugs — full control over relay mapping, scheduling logic, and the mobile UI, without subscription fees.
