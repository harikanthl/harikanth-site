---
title: "Building the Cockpit: a compute dial, an agent on a leash, and a memory that doesn't forget"
date: 2026-06-29
...
The [1.4 tour](/blog/kekasatori-1-4) is the what. This is the how. 1.4 was the release where Kekasatori stopped being three pillars that happened to share a window (Discover, Compare, Run) and became one Cockpit where a piece of work has a home, an engine, and a memory. That is mostly an architecture problem, and the interesting parts are the seams.
